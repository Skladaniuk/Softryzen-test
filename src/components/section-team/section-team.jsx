      ...
      <ul className={scss.teamItems}>
        <li>
          <div className={scss.imgWrapper}>
            ...
            <ul className={scss.socialLinks}>
              <li>
                <a
                  href="https://facebook.com"
                  title="facebook"
                  className={scss.socialLinks__link}
                >
                  <svg
                    width="35"
                    height="35"
        ...
        <li>
          ...
          <p className={scss.sectionTeam__roleMarketing}>Marketing Head</p>
        </li>
      </ul>
    </div>
  );
